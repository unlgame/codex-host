---
name: web-gui-tester
description: Verify web frontend behavior through real GUI interactions, read-only page inspection, and screenshots. Use for frontend acceptance tests, bug reproduction, interaction feedback, and visual checks with the browser tools available in the session.
---
